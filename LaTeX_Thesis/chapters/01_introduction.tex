...
\begin{enumerate}
    \item \textbf{Dataset Analysis}: Analysis of the KVP10k dataset, including layout clustering, spatial pattern analysis, and annotation statistics (Chapter~\ref{ch:dataset})
