...
\begin{enumerate}
    ...
    \item \textbf{Diagnostic Pipeline Analysis}: Systematic identification and correction of three compounding data-pipeline bugs, yielding the corrected V4 model with link F1\,=\,0.673 (Chapter~\ref{ch:exresults})
