...
\begin{enumerate}
    ...
    \item \textbf{Diagnostic Pipeline Analysis}: Systematic identification and correction of three compounding data-pipeline bugs, yielding the corrected V4 model with link F1\,=\,0.342 (text-only) / 0.309 (text+location) (Chapter~\ref{ch:exresults})
