...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}lcccc@{}}
    ...
    \midrule
    0 (Dense)  & 465 & 48.7 & 40.5 & 31.2 \\
    1 (Sparse) & 116 & 14.4 & \textbf{52.9} & 41.1 \\
    \bottomrule
  \end{tabular}
\end{table}
...
in the actual document. With only 1.9 KVPs per page on average in sparse
documents, the model over-generates (889 predictions vs.\ 224 ground-truth for
Cluster~1), producing a $3.97\times$ over-generation ratio. This is a
...
\begin{table}[ht]
  ...
  \begin{tabular}{@{}lccl@{}}
    ...
    Exp 1: Mistral-7B (text+loc) & --- & 0.600 & 52.9\% hallucination on sparse layouts \\
