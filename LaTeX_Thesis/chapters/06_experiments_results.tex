...
and approximate spatial grounding motivate a shift to a layout-aware discriminative
...
The corrected Stage~2 model assigns each coordinate-bearing test page using
...
\begin{table}[ht]
  \centering
  \caption{Experiment~1 regular-KVP macro F1 by corrected page-level
...
\begin{table}[ht]
  \centering
  \caption{Experiment~8: V4 regular-KVP macro F1 by corrected page-level
...
some documents through unsupported text generation, which token-grounded
