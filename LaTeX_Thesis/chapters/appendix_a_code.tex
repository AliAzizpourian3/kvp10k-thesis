...
\section{Normalized Edit Distance}
\label{app:metrics}

These listings supplement the evaluation protocol in
Section~\ref{sec:evaluation-protocol}.

\begin{lstlisting}[language=Python,
  basicstyle=\ttfamily\fontsize{7.5}{8.6}\selectfont,
...
This listing supplements the cluster-assignment procedure in
Section~\ref{subsec:cluster_use}. The following excerpt assumes that the
prepared dataset, page groups, and training-fitted annotation-geometry
clustering artifact (including its scaler and k-means model) have already been
loaded.
