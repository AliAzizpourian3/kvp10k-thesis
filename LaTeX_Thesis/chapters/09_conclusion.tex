...
\begin{enumerate}
    ...
    approach and identified its failure modes: hallucination on sparse layouts
    ...
    published scores ($0.659/0.611$); diagnostic analyses
...
the latter nevertheless produces substantial unsupported text on sparse pages.
...
diagnostic shows the remaining gap
...
detection or threshold choice, is the primary bottleneck for key-value
association: supplying ground-truth entities raises pooled diagnostic link F1
by only $\sim$0.03--0.05.

\section{Practical Implications}
\label{sec:implications}

This work shows a useful trade-off for discriminative multimodal models: they
