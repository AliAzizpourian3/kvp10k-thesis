...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrrrr}
        ...
        \textbf{Cluster} & \textbf{$n_{\text{boxes}}$ mean} & \textbf{$n_{\text{boxes}}$ std}
            & \textbf{area mean} & \textbf{area std}
            & \textbf{mean\,area mean} & \textbf{mean\,area std}
            & \textbf{density mean} & \textbf{density std} \\
        \midrule
        0 (text-rich)   & 25.3622 & 20.5338 & 0.0582 & 0.0467 & 0.0029 & 0.0030 & 0.0582 & 0.0467 \\
        1 (text-sparse) &  0.0619 &  0.6941 & 0.0001 & 0.0009 & 0.0000 & 0.0002 & 0.0001 & 0.0009 \\
        \bottomrule
    \end{tabular}
\end{table}
\begin{itemize}
