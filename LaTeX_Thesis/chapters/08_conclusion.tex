...
\begin{enumerate}
  ...
  F1 of $0.345$, compared with $0.521$ for Mistral.
...
The final corrected V4 system reaches Regular text+location F1 of $0.345$.
The reconstructed Mistral baseline remains stronger at $0.521$. The
discriminative system has a different constraint: its output text comes from
observed input tokens and cannot contain generated text that is absent from the
extracted input. V4 does not solve complete pair extraction and does not
outperform the generative baseline.
...
official Regular combined F1 of $0.345$. Because several procedures change together, the
...
V4 reaches Regular combined F1 of $0.305$ in Cluster~0 and $0.410$ in
Cluster~1. Mistral has the opposite order, with $0.569$ and $0.429$. This is an
...
a controlled, reproducible result for text-and-layout processing without
genuine image content. Its official Regular combined F1 of $0.345$ remains
below the reconstructed Mistral result. The principal finding is therefore diagnostic: comparatively stronger entity
recognition does not by itself translate into equally strong complete
key--value relation extraction. Future work could investigate stronger relation
structure and evaluate genuine visual input under controlled conditions.
