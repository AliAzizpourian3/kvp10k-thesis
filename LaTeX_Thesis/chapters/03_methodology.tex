...
with a linker head and jointly fine-tuned on the KVP10k dataset.
...
V4 is the corrected V2 pipeline and was warm-started from a prior checkpoint;
...
The underlying LayoutLMv3 architecture can also accept document-image patches,
but the final V4 experiments did not use page-image content. The encoder output
representations are consumed in parallel by the entity-classification head and
the linker head.
...
entities in specific image regions. This capability was not used with actual
page-image content in the V4 experiments.
...
associations, resulting in a legacy pooled diagnostic link F1 of approximately
$0.008$ (see
