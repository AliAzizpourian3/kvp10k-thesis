...
entity F1~$= 0.827$ and link F1~$= 0.342$ under the text-only metric
(NED\,$<0.2$, the same threshold as the published KVP10k baseline of 0.659),
and $0.309$ under the stricter text+location metric. The discriminative model
thus does not reach the generative baseline on linking; diagnostic analyses
