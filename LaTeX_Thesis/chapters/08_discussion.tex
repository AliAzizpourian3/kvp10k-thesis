...
Stratifying Stage~3 results by the corrected Stage~2 annotation-geometry
clusters (Table~\ref{tab:exp1-cluster}) shows an association between polygon
geometry and performance. The generative baseline reaches regular-pair text
...
\begin{table}[ht]
  \centering
  \caption{Stage~4 regular-KVP macro F1 by corrected page-level annotation-geometry cluster.}
...
only the test-page grouping was corrected.
