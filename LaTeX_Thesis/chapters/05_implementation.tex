...
\begin{enumerate}
  ...
  \item Stage~2: Unique-page annotation-geometry clustering and analysis
...
\begin{enumerate}
  ...
  benchmark semantics (type-aware greedy pair matching; evaluate text-only,
  location-only, and combined metrics; average precision and recall per page,
  then compute F1 from those macro averages).
