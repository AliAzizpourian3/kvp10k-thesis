#!/bin/bash
#SBATCH --job-name=kvp_4b_l10
#SBATCH --output=logs/kvp_stage4b_l10-%j.out
#SBATCH --error=logs/kvp_stage4b_l10-%j.err
...
python code/script/train_stage4b.py \
  ...
  --output_dir          data/outputs/stage4b_l10 \
  --batch_size          1 \
